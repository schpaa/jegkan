...
markdown.transformers.empty_line = (function markdown$transformers$empty_line(text,p__74691){
var map__74692 = p__74691;
var map__74692__$1 = cljs.core.__destructure_map(map__74692);
var state = map__74692__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74692__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74692__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
...
var G__74767 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq("<sup>"),cljs.core.second(remaining),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.seq("</sup>")], 0)));
var G__74768 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),remaining);
buf = G__74767;
remaining = G__74768;
continue;
} else {
var G__74771 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(remaining));
var G__74772 = cljs.core.rest(remaining);
buf = G__74771;
remaining = G__74772;
continue;
...
markdown.transformers.heading = (function markdown$transformers$heading(text,p__74708){
var map__74709 = p__74708;
var map__74709__$1 = cljs.core.__destructure_map(map__74709);
var state = map__74709__$1;
var buf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74709__$1,new cljs.core.Keyword(null,"buf","buf",-213913340));
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74709__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74709__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74709__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var heading_anchors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74709__$1,new cljs.core.Keyword(null,"heading-anchors","heading-anchors",1713527866));
...
markdown.transformers.br = (function markdown$transformers$br(text,p__74718){
var map__74719 = p__74718;
var map__74719__$1 = cljs.core.__destructure_map(map__74719);
var state = map__74719__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74719__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74719__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
markdown.transformers.autourl_transformer = (function markdown$transformers$autourl_transformer(text,p__74723){
var map__74724 = p__74723;
var map__74724__$1 = cljs.core.__destructure_map(map__74724);
var state = map__74724__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74724__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var frozen_strings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74724__$1,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.string.replace(text,/<https?:\/\/[-A-Za-z0-9+&@#\/%?=~_()|!:,.;]*[-A-Za-z0-9+&@#\/%=~_()|]>/,(function (p1__74721_SHARP_){
var vec__74725 = markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__74721_SHARP_,(1),(cljs.core.count(p1__74721_SHARP_) - (1))),cljs.core.deref(currently_frozen)], 0));
var url = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74725,(0),null);
var frozen_strings__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74725,(1),null);
...
return ["0",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__74729)].join('');
} else {
return G__74729;
}
});
...
})())?text:clojure.string.replace(text,/<[\w._%+-]+@[\w.-]+\.[\w]{2,4}>/,(function (p1__74728_SHARP_){
var encoded = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2(encoder,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__74728_SHARP_,(1),(cljs.core.count(p1__74728_SHARP_) - (1)))));
...
markdown.transformers.set_line_state = (function markdown$transformers$set_line_state(text,p__74730){
var map__74731 = p__74730;
var map__74731__$1 = cljs.core.__destructure_map(map__74731);
var state = map__74731__$1;
var inline_heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74731__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
...
markdown.transformers.open_paragraph = (function markdown$transformers$open_paragraph(text,p__74732){
var map__74733 = p__74732;
var map__74733__$1 = cljs.core.__destructure_map(map__74733);
var state = map__74733__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74733__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74733__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
var blockquote = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74733__$1,new cljs.core.Keyword(null,"blockquote","blockquote",372264190));
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74733__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var hr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74733__$1,new cljs.core.Keyword(null,"hr","hr",1377740067));
var temp = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74733__$1,new cljs.core.Keyword(null,"temp","temp",1791541284));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74733__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var inline_heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74733__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74733__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74733__$1,new cljs.core.Keyword(null,"code","code",1586293142));
...
markdown.transformers.close_paragraph = (function markdown$transformers$close_paragraph(text,p__74734){
var map__74735 = p__74734;
var map__74735__$1 = cljs.core.__destructure_map(map__74735);
var state = map__74735__$1;
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74735__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74735__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
if(cljs.core.truth_((function (){var and__4251__auto__ = paragraph;
if(cljs.core.truth_(and__4251__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last((3),(function (){var G__74736 = next_line;
if((G__74736 == null)){
return null;
} else {
return clojure.string.trim(G__74736);
}
})()));
} else {
return and__4251__auto__;
...
markdown.transformers.code = (function markdown$transformers$code(text,p__74737){
var map__74738 = p__74737;
var map__74738__$1 = cljs.core.__destructure_map(map__74738);
var state = map__74738__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74738__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74738__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74738__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74738__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74738__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
...
markdown.transformers.codeblock = (function markdown$transformers$codeblock(text,p__74739){
var map__74740 = p__74739;
var map__74740__$1 = cljs.core.__destructure_map(map__74740);
var state = map__74740__$1;
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74740__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var codeblock_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74740__$1,new cljs.core.Keyword(null,"codeblock-end","codeblock-end",1507794736));
var indented_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74740__$1,new cljs.core.Keyword(null,"indented-code","indented-code",-904930175));
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74740__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74740__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var trimmed = clojure.string.trim(text);
var next_line_closes_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last((3),(function (){var G__74741 = next_line;
if((G__74741 == null)){
return null;
} else {
return clojure.string.trim(G__74741);
}
})()));
...
var vec__74742 = cljs.core.split_with(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.not_EQ_,"\n"),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((3),trimmed));
var lang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74742,(0),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74742,(1),null);
 ...
 */
markdown.transformers.blockquote_1 = (function markdown$transformers$blockquote_1(text,p__74745){
var map__74746 = p__74745;
var map__74746__$1 = cljs.core.__destructure_map(map__74746);
var state = map__74746__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74746__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74746__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74746__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74746__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var trimmed = clojure.string.trim(text);
if(cljs.core.truth_((function (){var or__4253__auto__ = code;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
 ...
 */
markdown.transformers.blockquote_2 = (function markdown$transformers$blockquote_2(text,p__74747){
var map__74748 = p__74747;
var map__74748__$1 = cljs.core.__destructure_map(map__74748);
var state = map__74748__$1;
var blockquote_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74748__$1,new cljs.core.Keyword(null,"blockquote-start","blockquote-start",276074935));
var blockquote_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74748__$1,new cljs.core.Keyword(null,"blockquote-end","blockquote-end",1122544964));
var blockquote_paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74748__$1,new cljs.core.Keyword(null,"blockquote-paragraph","blockquote-paragraph",1931783682));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74748__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
return (function (p1__74749_SHARP_){
return ["<ol class='footnotes'>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__74749_SHARP_),"</ol>"].join('');
})(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (footnotes__$1,p__74750){
var vec__74751 = p__74750;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74751,(0),null);
var label = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74751,(1),null);
...
var vec__74754 = cljs.core.re_matches(/^([0-9A-Za-z_-]*):(.*)$/,line);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74754,(0),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74754,(1),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74754,(2),null);
var vec__74757 = cljs.core.re_matches(/^    (.*)$/,line);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74757,(0),null);
var next_val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74757,(1),null);
...
var vec__74763 = ((cljs.core.sequential_QMARK_(data))?data:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [prev_key,data], null));
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74763,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74763,(1),null);
...
var G__74827 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([acc,cljs.core.PersistentArrayMap.createAsIfByAssoc([key,new_val])], 0));
var G__74828 = cljs.core.rest(remain);
var G__74829 = key;
acc = G__74827;
remain = G__74828;
prev_key = G__74829;
