...
var len__4864__auto___74478 = arguments.length;
var i__4865__auto___74479 = (0);
while(true){
if((i__4865__auto___74479 < len__4864__auto___74478)){
args__4870__auto__.push((arguments[i__4865__auto___74479]));

var G__74480 = (i__4865__auto___74479 + (1));
i__4865__auto___74479 = G__74480;
continue;
} else {
}
break;
...
/** @this {Function} */
(markdown.common.freeze_string.cljs$lang$applyTo = (function (seq74435){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq74435));
}));
...
var G__74481 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (text,state,matches,temp__5751__auto__){
return (function (s,r){
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560).cljs$core$IFn$_invoke$arity$1(state),p1__74436_SHARP_,p1__74436_SHARP_);
});})(text,state,matches,temp__5751__auto__))
);
});})(text,state,matches,temp__5751__auto__))
,text,matches);
var G__74482 = cljs.core.update.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560),((function (text,state,matches,temp__5751__auto__){
return (function (p1__74437_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc,p1__74437_SHARP_,matches);
});})(text,state,matches,temp__5751__auto__))
);
text = G__74481;
state = G__74482;
...
var vec__74450 = (((transformer === cljs.core.identity))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [buf,cur_state], null):(function (){var vec__74453 = (function (){var G__74456 = clojure.string.join.cljs$core$IFn$_invoke$arity$1(buf);
var G__74457 = cur_state;
return (transformer.cljs$core$IFn$_invoke$arity$2 ? transformer.cljs$core$IFn$_invoke$arity$2(G__74456,G__74457) : transformer.call(null,G__74456,G__74457));
})();
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74453,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74453,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.seq(s),new_state], null);
})());
var new_buf = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74450,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74450,(1),null);
var G__74500 = cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(out,cljs.core.seq(open),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new_buf,cljs.core.seq(close)], 0)));
var G__74501 = cljs.core.PersistentVector.EMPTY;
var G__74502 = cljs.core.rest(tokens);
var G__74503 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(new_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),false);
out = G__74500;
buf = G__74501;
tokens = G__74502;
cur_state = G__74503;
...
var G__74504 = out;
var G__74505 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(tokens));
var G__74506 = cljs.core.rest(tokens);
var G__74507 = cur_state;
out = G__74504;
buf = G__74505;
tokens = G__74506;
cur_state = G__74507;
...
var G__74508 = out;
var G__74509 = buf;
var G__74510 = cljs.core.rest(tokens);
var G__74511 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cur_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),true);
out = G__74508;
buf = G__74509;
tokens = G__74510;
cur_state = G__74511;
...
var G__74512 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(out,cljs.core.first(tokens));
var G__74513 = buf;
var G__74514 = cljs.core.rest(tokens);
var G__74515 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cur_state,new cljs.core.Keyword(null,"in-tag?","in-tag?",1693672911),markdown.common.open_html_tags(new cljs.core.Keyword(null,"in-tag?","in-tag?",1693672911).cljs$core$IFn$_invoke$arity$1(cur_state),cljs.core.first(tokens)));
out = G__74512;
buf = G__74513;
tokens = G__74514;
cur_state = G__74515;
...
var num_hashes = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__74468_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__74468_SHARP_);
}),cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__74469_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",p1__74469_SHARP_)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__74469_SHARP_)));
}),cljs.core.seq(text))));
if((num_hashes > (0))){
return num_hashes;
} else {
