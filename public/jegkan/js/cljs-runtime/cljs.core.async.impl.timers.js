...
var i_41006 = (0);
while(true){
if((i_41006 < arr.length)){
(arr[i_41006] = null);

var G__41007 = (i_41006 + (1));
i_41006 = G__41007;
continue;
} else {
}
...
var i_41014 = (self__.level + (1));
while(true){
if((i_41014 <= (new_level + (1)))){
(update[i_41014] = self__.header);

var G__41015 = (i_41014 + (1));
i_41014 = G__41015;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_41016 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_41016[i]));
} else {
x__$2.forward.push((((i < links_41016.length))?(links_41016[i]):null));
}

if((i < links_41016.length)){
(links_41016[i] = x__$2);
} else {
links_41016.push(x__$2);
}
...
var i_41018 = (0);
while(true){
if((i_41018 <= self__.level)){
var links_41020 = (update[i_41018]).forward;
if((x__$1 === (((i_41018 < links_41020.length))?(links_41020[i_41018]):null))){
(links_41020[i_41018] = (x__$1.forward[i_41018]));

var G__41022 = (i_41018 + (1));
i_41018 = G__41022;
continue;
} else {
var G__41023 = (i_41018 + (1));
i_41018 = G__41023;
continue;
}
} else {
...
var G__41029 = nx;
var G__41030 = (level__$1 - (1));
x = G__41029;
level__$1 = G__41030;
continue;
} else {
var G__41031 = x;
var G__41032 = (level__$1 - (1));
x = G__41031;
level__$1 = G__41032;
continue;
}
