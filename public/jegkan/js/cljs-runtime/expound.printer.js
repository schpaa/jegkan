...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57359_SHARP_){
return expound.printer.str_width(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__57359_SHARP_,i))));
}),rows));
});
expound.printer.max_row_height = (function expound$printer$max_row_height(row){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57360_SHARP_){
return cljs.core.count(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57360_SHARP_)));
}),row));
});
...
var G__57367 = ["%-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(column_widths,i)),"s"].join('');
var G__57368 = v;
return (expound.printer.format.cljs$core$IFn$_invoke$arity$2 ? expound.printer.format.cljs$core$IFn$_invoke$arity$2(G__57367,G__57368) : expound.printer.format.call(null,G__57367,G__57368));
}),row);
}),multi_row);
}),multi_rows);
});
...
var columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57369_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57369_SHARP_)).length),"-"));
}),header);
var header_columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57370_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57370_SHARP_)).length),"="));
}),header);
...
var iter__4652__auto__ = (function expound$printer$multirow_$_iter__57371(s__57372){
return (new cljs.core.LazySeq(null,(function (){
var s__57372__$1 = s__57372;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__57372__$1);
if(temp__5753__auto__){
var s__57372__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__57372__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__57372__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__57374 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__57373 = (0);
while(true){
if((i__57373 < size__4651__auto__)){
var row_idx = cljs.core._nth(c__4650__auto__,i__57373);
cljs.core.chunk_append(b__57374,(function (){var iter__4652__auto__ = ((function (i__57373,row_idx,c__4650__auto__,size__4651__auto__,b__57374,s__57372__$2,temp__5753__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__57371_$_iter__57376(s__57377){
return (new cljs.core.LazySeq(null,((function (i__57373,row_idx,c__4650__auto__,size__4651__auto__,b__57374,s__57372__$2,temp__5753__auto__,split_row_contents){
return (function (){
var s__57377__$1 = s__57377;
while(true){
var temp__5753__auto____$1 = cljs.core.seq(s__57377__$1);
if(temp__5753__auto____$1){
var s__57377__$2 = temp__5753__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__57377__$2)){
var c__4650__auto____$1 = cljs.core.chunk_first(s__57377__$2);
var size__4651__auto____$1 = cljs.core.count(c__4650__auto____$1);
var b__57379 = cljs.core.chunk_buffer(size__4651__auto____$1);
if((function (){var i__57378 = (0);
while(true){
if((i__57378 < size__4651__auto____$1)){
var col_idx = cljs.core._nth(c__4650__auto____$1,i__57378);
cljs.core.chunk_append(b__57379,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__57527 = (i__57378 + (1));
i__57378 = G__57527;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57379),expound$printer$multirow_$_iter__57371_$_iter__57376(cljs.core.chunk_rest(s__57377__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57379),null);
}
} else {
var col_idx = cljs.core.first(s__57377__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__57371_$_iter__57376(cljs.core.rest(s__57377__$2)));
}
} else {
return null;
}
...
});})(i__57373,row_idx,c__4650__auto__,size__4651__auto__,b__57374,s__57372__$2,temp__5753__auto__,split_row_contents))
,null,null));
});})(i__57373,row_idx,c__4650__auto__,size__4651__auto__,b__57374,s__57372__$2,temp__5753__auto__,split_row_contents))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57374),expound$printer$multirow_$_iter__57371(cljs.core.chunk_rest(s__57372__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57374),null);
}
} else {
var row_idx = cljs.core.first(s__57372__$2);
return cljs.core.cons((function (){var iter__4652__auto__ = ((function (row_idx,s__57372__$2,temp__5753__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__57371_$_iter__57381(s__57382){
return (new cljs.core.LazySeq(null,(function (){
var s__57382__$1 = s__57382;
while(true){
var temp__5753__auto____$1 = cljs.core.seq(s__57382__$1);
if(temp__5753__auto____$1){
var s__57382__$2 = temp__5753__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__57382__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__57382__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__57384 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__57383 = (0);
while(true){
if((i__57383 < size__4651__auto__)){
var col_idx = cljs.core._nth(c__4650__auto__,i__57383);
cljs.core.chunk_append(b__57384,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__57529 = (i__57383 + (1));
i__57383 = G__57529;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57384),expound$printer$multirow_$_iter__57371_$_iter__57381(cljs.core.chunk_rest(s__57382__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57384),null);
}
} else {
var col_idx = cljs.core.first(s__57382__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__57371_$_iter__57381(cljs.core.rest(s__57382__$2)));
}
} else {
return null;
}
...
});})(row_idx,s__57372__$2,temp__5753__auto__,split_row_contents))
;
return iter__4652__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(cljs.core.count(row)));
})(),expound$printer$multirow_$_iter__57371(cljs.core.rest(s__57372__$2)));
}
} else {
return null;
}
...
var rows = cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [column_keys], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57391_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(p1__57391_SHARP_,column_keys);
}),map_rows));
...
var form = (function (){var G__57404 = via;
var G__57404__$1 = (((G__57404 == null))?null:cljs.core.last(G__57404));
if((G__57404__$1 == null)){
return null;
} else {
return cljs.spec.alpha.form(G__57404__$1);
}
})();
...
var seq__57409_57542 = cljs.core.seq(problems);
var chunk__57410_57543 = null;
var count__57411_57544 = (0);
var i__57412_57545 = (0);
while(true){
if((i__57412_57545 < count__57411_57544)){
var p_57546 = chunk__57410_57543.cljs$core$IIndexed$_nth$arity$2(null,i__57412_57545);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_57546) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__57547 = seq__57409_57542;
var G__57548 = chunk__57410_57543;
var G__57549 = count__57411_57544;
var G__57550 = (i__57412_57545 + (1));
seq__57409_57542 = G__57547;
chunk__57410_57543 = G__57548;
count__57411_57544 = G__57549;
i__57412_57545 = G__57550;
continue;
} else {
var temp__5753__auto___57551 = cljs.core.seq(seq__57409_57542);
if(temp__5753__auto___57551){
var seq__57409_57552__$1 = temp__5753__auto___57551;
if(cljs.core.chunked_seq_QMARK_(seq__57409_57552__$1)){
var c__4679__auto___57553 = cljs.core.chunk_first(seq__57409_57552__$1);
var G__57554 = cljs.core.chunk_rest(seq__57409_57552__$1);
var G__57555 = c__4679__auto___57553;
var G__57556 = cljs.core.count(c__4679__auto___57553);
var G__57557 = (0);
seq__57409_57542 = G__57554;
chunk__57410_57543 = G__57555;
count__57411_57544 = G__57556;
i__57412_57545 = G__57557;
continue;
} else {
var p_57559 = cljs.core.first(seq__57409_57552__$1);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_57559) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__57563 = cljs.core.next(seq__57409_57552__$1);
var G__57564 = null;
var G__57565 = (0);
var G__57566 = (0);
seq__57409_57542 = G__57563;
chunk__57410_57543 = G__57564;
count__57411_57544 = G__57565;
i__57412_57545 = G__57566;
continue;
}
} else {
}
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,k,((cljs.core.qualified_keyword_QMARK_(k))?k:(function (){var or__4253__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57408_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),cljs.core.name(p1__57408_SHARP_));
}),specs));
...
expound.printer.summarize_key_clause = (function expound$printer$summarize_key_clause(p__57419){
var vec__57420 = p__57419;
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57420,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57420,(1),null);
var G__57423 = branch;
...
var vec__57428 = cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","contains-key-pred","expound.spec/contains-key-pred",-989075236),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,(2)));
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57428,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57428,(1),null);
var G__57431 = branch;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57431__$1)].join('')));
...
var len__4864__auto___57571 = arguments.length;
var i__4865__auto___57572 = (0);
while(true){
if((i__4865__auto___57572 < len__4864__auto___57571)){
args__4870__auto__.push((arguments[i__4865__auto___57572]));

var G__57573 = (i__4865__auto___57572 + (1));
i__4865__auto___57572 = G__57573;
continue;
} else {
}
break;
...
/** @this {Function} */
(expound.printer.format.cljs$lang$applyTo = (function (seq57436){
var G__57437 = cljs.core.first(seq57436);
var seq57436__$1 = cljs.core.next(seq57436);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57437,seq57436__$1);
}));
...
var keys = expound.printer.keywords(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57444_SHARP_){
return expound.printer.missing_key(new cljs.core.Keyword(null,"pred","pred",1927423397).cljs$core$IFn$_invoke$arity$1(p1__57444_SHARP_));
}),problems));
...
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p1__57445_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__57445_SHARP_,"key");
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__57449){
...
var _STAR_print_newline_STAR__orig_val__57453_57580 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57454_57581 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57455_57582 = true;
var _STAR_print_fn_STAR__temp_val__57456_57583 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57455_57582);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57456_57583);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57454_57581);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57453_57580);
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57457_SHARP_){
return expound.ansi.color.cljs$core$IFn$_invoke$arity$variadic(p1__57457_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"correct-key","correct-key",1087492967)], 0));
...
var vec__57470 = clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(s));
...
var line = first__57472;
var lines = seq__57471__$1;
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(first_line_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)].join('')], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57467_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(rest_lines_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57467_SHARP_)].join('');
}),lines)));
}));
...
while(true){
var vec__57478 = in$;
var seq__57479 = cljs.core.seq(vec__57478);
var first__57480 = cljs.core.first(seq__57479);
var seq__57479__$1 = cljs.core.next(seq__57479);
var k = first__57480;
var rst = seq__57479__$1;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(displayed_form,new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k)),(function (){var G__57481 = show_valid_values_QMARK_;
var G__57482 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k);
var G__57483 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__57481,G__57482,G__57483) : expound.printer.summary_form.call(null,G__57481,G__57482,G__57483));
})(),new cljs.core.Keyword("expound.problems","irrelevant","expound.problems/irrelevant",2090226124));
} else {
if(((cljs.core.map_QMARK_(form)) && (expound.paths.kvps_QMARK_(k)))){
var G__57593 = show_valid_values_QMARK_;
var G__57594 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(k));
var G__57595 = rst__$1;
show_valid_values_QMARK_ = G__57593;
form = G__57594;
in$ = G__57595;
continue;
} else {
if(cljs.core.associative_QMARK_(form)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(displayed_form,k,(function (){var G__57484 = show_valid_values_QMARK_;
var G__57485 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(form,k);
var G__57486 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__57484,G__57485,G__57486) : expound.printer.summary_form.call(null,G__57484,G__57485,G__57486));
})());
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.seq_QMARK_(form)))){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__57487 = show_valid_values_QMARK_;
var G__57488 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,k);
var G__57489 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__57487,G__57488,G__57489) : expound.printer.summary_form.call(null,G__57487,G__57488,G__57489));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.set_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__57492 = show_valid_values_QMARK_;
var G__57493 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__57494 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__57492,G__57493,G__57494) : expound.printer.summary_form.call(null,G__57492,G__57493,G__57494));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.list_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.List.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__57495 = show_valid_values_QMARK_;
var G__57496 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__57497 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__57495,G__57496,G__57497) : expound.printer.summary_form.call(null,G__57495,G__57496,G__57497));
})()));
} else {
...
var max_width = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57499_SHARP_){
return ((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57499_SHARP_)).length);
...
var map__57504 = problem;
var map__57504__$1 = cljs.core.__destructure_map(map__57504);
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57504__$1,new cljs.core.Keyword("expound","form","expound/form",-264680632));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57504__$1,new cljs.core.Keyword("expound","in","expound/in",-1900412298));
var map__57505 = opts;
var map__57505__$1 = cljs.core.__destructure_map(map__57505);
var show_valid_values_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__57505__$1,new cljs.core.Keyword(null,"show-valid-values?","show-valid-values?",-587258094),false);
...
var s = (function (){var _STAR_print_namespace_maps_STAR__orig_val__57510 = cljs.core._STAR_print_namespace_maps_STAR_;
var _STAR_print_namespace_maps_STAR__temp_val__57511 = false;
(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__temp_val__57511);
...
}finally {(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__orig_val__57510);
}})();
var vec__57506 = cljs.core.re_find(regex,s);
var seq__57507 = cljs.core.seq(vec__57506);
var first__57508 = cljs.core.first(seq__57507);
var seq__57507__$1 = cljs.core.next(seq__57507);
var line = first__57508;
var first__57508__$1 = cljs.core.first(seq__57507__$1);
var seq__57507__$2 = cljs.core.next(seq__57507__$1);
var prefix = first__57508__$1;
var _more = seq__57507__$2;
