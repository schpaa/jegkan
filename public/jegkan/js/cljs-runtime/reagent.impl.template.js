...
var G__52597 = o;
reagent.impl.template.goog$module$goog$object.set(G__52597,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__52616__i < G__52616__a.length) {G__52616__a[G__52616__i] = arguments[G__52616__i + 0]; ++G__52616__i;}
  args = new cljs.core.IndexedSeq(G__52616__a,0,null);
} 
...
var args = cljs.core.seq(arglist__52617);
...
var G__52598 = o;
reagent.impl.template.goog$module$goog$object.set(G__52598,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__52618__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__52619__i < G__52619__a.length) {G__52619__a[G__52619__i] = arguments[G__52619__i + 0]; ++G__52619__i;}
  args = new cljs.core.IndexedSeq(G__52619__a,0,null);
} 
return G__52618__delegate.call(this,args);};
G__52618.cljs$lang$maxFixedArity = 0;
G__52618.cljs$lang$applyTo = (function (arglist__52620){
var args = cljs.core.seq(arglist__52620);
return G__52618__delegate(args);
});
...
var G__52599 = props;
var G__52599__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52599,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__52599);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52599__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__52600 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52600,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__52600;
}
})(),id_class);
...
var G__52601 = (cljs.core.count(argv) - first_child);
switch (G__52601) {
case (0):
...
var vec__52602 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52602,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52602,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52602,(2),null);
...
var temp__5757__auto___52624 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___52624 == null)){
} else {
var key_52625 = temp__5757__auto___52624;
(jsprops.key = key_52625);
}
...
var temp__5757__auto___52628 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___52628 == null)){
} else {
var key_52629 = temp__5757__auto___52628;
(jsprops.key = key_52629);
}
...
var temp__5757__auto___52632 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___52632 == null)){
} else {
var key_52633 = temp__5757__auto___52632;
(jsprops.key = key_52633);
}
...
var temp__5757__auto___52638 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___52638 == null)){
} else {
var key_52639 = temp__5757__auto___52638;
(jsprops.key = key_52639);
}
...
var temp__5757__auto___52640 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___52640 == null)){
} else {
var key_52641 = temp__5757__auto___52640;
(jsprops.key = key_52641);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52605_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__52605_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__52606 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52606,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52606,(1),null);
...
break;
default:
var G__52648 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__52649 = compiler;
v = G__52648;
compiler = G__52649;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template52612 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template52612 = (function (opts,id,fn_to_element,parse_fn,meta52613){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta52613 = meta52613;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template52612.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_52614,meta52613__$1){
var self__ = this;
var _52614__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template52612(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta52613__$1));
}));

(reagent.impl.template.t_reagent$impl$template52612.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_52614){
var self__ = this;
var _52614__$1 = this;
return self__.meta52613;
}));

(reagent.impl.template.t_reagent$impl$template52612.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template52612.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template52612.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template52612.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template52612.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template52612.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta52613","meta52613",933144992,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template52612.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template52612.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template52612");

(reagent.impl.template.t_reagent$impl$template52612.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template52612");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template52612.
 */
reagent.impl.template.__GT_t_reagent$impl$template52612 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template52612(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta52613){
return (new reagent.impl.template.t_reagent$impl$template52612(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta52613));
});

}

return (new reagent.impl.template.t_reagent$impl$template52612(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
