...
return clojure.string.join.cljs$core$IFn$_invoke$arity$1((function (){var iter__4652__auto__ = (function markdown$lists$close_lists_$_iter__74556(s__74557){
return (new cljs.core.LazySeq(null,(function (){
var s__74557__$1 = s__74557;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__74557__$1);
if(temp__5753__auto__){
var s__74557__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__74557__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__74557__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__74559 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__74558 = (0);
while(true){
if((i__74558 < size__4651__auto__)){
var vec__74563 = cljs.core._nth(c__4650__auto__,i__74558);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74563,(0),null);
cljs.core.chunk_append(b__74559,["</li></",cljs.core.name(list_type),">"].join(''));

var G__74626 = (i__74558 + (1));
i__74558 = G__74626;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__74559),markdown$lists$close_lists_$_iter__74556(cljs.core.chunk_rest(s__74557__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__74559),null);
}
} else {
var vec__74572 = cljs.core.first(s__74557__$2);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74572,(0),null);
return cljs.core.cons(["</li></",cljs.core.name(list_type),">"].join(''),markdown$lists$close_lists_$_iter__74556(cljs.core.rest(s__74557__$2)));
}
} else {
return null;
}
...
var lists_to_close = cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__74575_SHARP_){
return (cljs.core.second(p1__74575_SHARP_) > num_indents);
...
var vec__74604 = cljs.core.last(new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74604,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74604,(1),null);
...
var vec__74611 = cljs.core.last(new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74611,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74611,(1),null);
var num_indents = cljs.core.count(cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core._EQ_," "),text));
...
markdown.lists.li = (function markdown$lists$li(text,p__74614){
var map__74615 = p__74614;
var map__74615__$1 = cljs.core.__destructure_map(map__74615);
var state = map__74615__$1;
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74615__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74615__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74615__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74615__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
