...
var G__67858 = cljs.core.next(xs);
var G__67859 = cljs.core.next(ys);
xs = G__67858;
ys = G__67859;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__67819 = val;
var G__67820 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__67819,G__67820) : f.call(null,G__67819,G__67820));
})();
...
while(true){
if((n < cnt)){
var nval = (function (){var G__67821 = val__$1;
var G__67822 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__67821,G__67822) : f.call(null,G__67821,G__67822));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__67823 = val__$1;
var G__67824 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__67823,G__67824) : f.call(null,G__67823,G__67824));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var G__67869 = cljs.core.next(es);
var G__67870 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__67869;
tcoll__$1 = G__67870;
continue;
} else {
...
var G__67871 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__67872 = cljs.core.next(es);
ret = G__67871;
es = G__67872;
continue;
} else {
