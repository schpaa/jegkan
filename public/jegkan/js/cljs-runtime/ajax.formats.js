...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__56710){
var map__56711 = p__56710;
var map__56711__$1 = cljs.core.__destructure_map(map__56711);
var request = map__56711__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56711__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__56714 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__56714.cljs$core$IFn$_invoke$arity$1 ? fexpr__56714.cljs$core$IFn$_invoke$arity$1(response) : fexpr__56714.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__56715 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__56715.cljs$core$IFn$_invoke$arity$1 ? fexpr__56715.cljs$core$IFn$_invoke$arity$1(response) : fexpr__56715.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__56716){
var map__56717 = p__56716;
var map__56717__$1 = cljs.core.__destructure_map(map__56717);
var request = map__56717__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56717__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
