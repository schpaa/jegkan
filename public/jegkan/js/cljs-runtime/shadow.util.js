...
var len__4864__auto___46690 = arguments.length;
var i__4865__auto___46691 = (0);
while(true){
if((i__4865__auto___46691 < len__4864__auto___46690)){
args_arr__4885__auto__.push((arguments[i__4865__auto___46691]));

var G__46692 = (i__4865__auto___46691 + (1));
i__4865__auto___46691 = G__46692;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq46657){
var G__46658 = cljs.core.first(seq46657);
var seq46657__$1 = cljs.core.next(seq46657);
var G__46659 = cljs.core.first(seq46657__$1);
var seq46657__$2 = cljs.core.next(seq46657__$1);
var G__46660 = cljs.core.first(seq46657__$2);
var seq46657__$3 = cljs.core.next(seq46657__$2);
var G__46661 = cljs.core.first(seq46657__$3);
var seq46657__$4 = cljs.core.next(seq46657__$3);
var G__46662 = cljs.core.first(seq46657__$4);
var seq46657__$5 = cljs.core.next(seq46657__$4);
var G__46663 = cljs.core.first(seq46657__$5);
var seq46657__$6 = cljs.core.next(seq46657__$5);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46658,G__46659,G__46660,G__46661,G__46662,G__46663,seq46657__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__46673){
var vec__46674 = p__46673;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46674,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46674,(1),null);
