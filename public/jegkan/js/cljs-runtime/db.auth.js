...
db.auth.user__GT_data = (function db$auth$user__GT_data(user){
if(cljs.core.truth_(user)){
return new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"email","email",1415816706),user.email,new cljs.core.Keyword(null,"photo-url","photo-url",-1816449182),user.photoURL,new cljs.core.Keyword(null,"uid","uid",-1447769400),user.uid,new cljs.core.Keyword(null,"display-name","display-name",694513143),user.displayName], null);
} else {
return null;
}
});
...
var user_data = db.auth.user__GT_data(user);
