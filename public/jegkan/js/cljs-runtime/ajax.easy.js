...
var G__56783 = format;
var G__56783__$1 = (((G__56783 instanceof cljs.core.Keyword))?G__56783.fqn:null);
switch (G__56783__$1) {
case "transit":
return ajax.transit.transit_request_format.cljs$core$IFn$_invoke$arity$1(format_params);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__56786 = cljs.core.second(format);
var G__56787 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__56786,G__56787) : ajax.easy.keyword_response_format_element.call(null,G__56786,G__56787));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__56789_SHARP_){
return ajax.easy.keyword_response_format_element(p1__56789_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__56792){
var map__56793 = p__56792;
var map__56793__$1 = cljs.core.__destructure_map(map__56793);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56793__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56793__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56793__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__56794){
var vec__56795 = p__56794;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56795,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56795,(1),null);
var fexpr__56798_56806 = (cljs.core.truth_(ok)?h:e);
(fexpr__56798_56806.cljs$core$IFn$_invoke$arity$1 ? fexpr__56798_56806.cljs$core$IFn$_invoke$arity$1(result) : fexpr__56798_56806.call(null,result));
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__56799){
var map__56800 = p__56799;
var map__56800__$1 = cljs.core.__destructure_map(map__56800);
var opts = map__56800__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56800__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56800__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56800__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56800__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56800__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
