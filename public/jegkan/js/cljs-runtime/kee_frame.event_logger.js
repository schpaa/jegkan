...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"event","event",301435442),event], null),((cljs.core.seq(effects))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"side-effects","side-effects",851436977),effects], null):null),((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new_db,new cljs.core.Keyword("kee-frame.event-logger","not-found","kee-frame.event-logger/not-found",1442366090)))?(function (){var vec__60677 = clojure.data.diff(orig_db,new_db);
var only_before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60677,(0),null);
var only_after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60677,(1),null);
