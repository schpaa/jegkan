...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_56287 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_56287(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_56288 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_56288(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_56289 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_56289(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_56290 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_56290(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_56292 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_56292(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_56294 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_56294(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_56295 = (function (this$,header){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_56295(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_56296 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_56296(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_56298 = (function (this$,request){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_56298(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_56300 = (function (this$,response){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_56300(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k56266,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k56266,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__56271){
var vec__56272 = p__56271;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56272,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56272,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__56265){
var self__ = this;
var G__56265__$1 = this;
return (new cljs.core.RecordIter((0),G__56265__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this56267,other56268){
var self__ = this;
var this56267__$1 = this;
return (((!((other56268 == null)))) && ((((this56267__$1.constructor === other56268.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56267__$1.status,other56268.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56267__$1.body,other56268.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56267__$1.status_text,other56268.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56267__$1.headers,other56268.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56267__$1.was_aborted,other56268.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56267__$1.__extmap,other56268.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k56266){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k56266);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__56265){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__56281 = cljs.core.keyword_identical_QMARK_;
var expr__56282 = k__4511__auto__;
if(cljs.core.truth_((pred__56281.cljs$core$IFn$_invoke$arity$2 ? pred__56281.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__56282) : pred__56281.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__56282)))){
return (new ajax.protocols.Response(G__56265,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56281.cljs$core$IFn$_invoke$arity$2 ? pred__56281.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__56282) : pred__56281.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__56282)))){
return (new ajax.protocols.Response(self__.status,G__56265,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56281.cljs$core$IFn$_invoke$arity$2 ? pred__56281.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__56282) : pred__56281.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__56282)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__56265,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56281.cljs$core$IFn$_invoke$arity$2 ? pred__56281.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__56282) : pred__56281.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__56282)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__56265,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56281.cljs$core$IFn$_invoke$arity$2 ? pred__56281.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__56282) : pred__56281.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__56282)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__56265,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__56265),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__56265){
var self__ = this;
var this__4501__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__56265,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__56269){
var extmap__4542__auto__ = (function (){var G__56286 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__56269,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__56269)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__56286);
} else {
return G__56286;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__56269),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__56269),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__56269),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__56269),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__56269),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
