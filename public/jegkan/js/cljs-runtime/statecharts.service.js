...
var statecharts$service$IService$start$dyn_67965 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
var m__4551__auto__ = (statecharts.service.start[goog.typeOf(x__4550__auto__)]);
if((!((m__4551__auto__ == null)))){
return (m__4551__auto__.cljs$core$IFn$_invoke$arity$1 ? m__4551__auto__.cljs$core$IFn$_invoke$arity$1(this$) : m__4551__auto__.call(null,this$));
} else {
var m__4549__auto__ = (statecharts.service.start["_"]);
...
return statecharts$service$IService$start$dyn_67965(this$);
}
});

var statecharts$service$IService$send$dyn_67966 = (function (this$,event){
var x__4550__auto__ = (((this$ == null))?null:this$);
var m__4551__auto__ = (statecharts.service.send[goog.typeOf(x__4550__auto__)]);
if((!((m__4551__auto__ == null)))){
...
var m__4549__auto__ = (statecharts.service.send["_"]);
if((!((m__4549__auto__ == null)))){
...
return statecharts$service$IService$send$dyn_67966(this$,event);
}
});

var statecharts$service$IService$add_listener$dyn_67967 = (function (this$,id,listener){
var x__4550__auto__ = (((this$ == null))?null:this$);
var m__4551__auto__ = (statecharts.service.add_listener[goog.typeOf(x__4550__auto__)]);
if((!((m__4551__auto__ == null)))){
return (m__4551__auto__.cljs$core$IFn$_invoke$arity$3 ? m__4551__auto__.cljs$core$IFn$_invoke$arity$3(this$,id,listener) : m__4551__auto__.call(null,this$,id,listener));
} else {
var m__4549__auto__ = (statecharts.service.add_listener["_"]);
if((!((m__4549__auto__ == null)))){
return (m__4549__auto__.cljs$core$IFn$_invoke$arity$3 ? m__4549__auto__.cljs$core$IFn$_invoke$arity$3(this$,id,listener) : m__4549__auto__.call(null,this$,id,listener));
} else {
...
return statecharts$service$IService$add_listener$dyn_67967(this$,id,listener);
}
});

var statecharts$service$IService$reload$dyn_67968 = (function (this$,fsm){
var x__4550__auto__ = (((this$ == null))?null:this$);
var m__4551__auto__ = (statecharts.service.reload[goog.typeOf(x__4550__auto__)]);
if((!((m__4551__auto__ == null)))){
return (m__4551__auto__.cljs$core$IFn$_invoke$arity$2 ? m__4551__auto__.cljs$core$IFn$_invoke$arity$2(this$,fsm) : m__4551__auto__.call(null,this$,fsm));
} else {
var m__4549__auto__ = (statecharts.service.reload["_"]);
if((!((m__4549__auto__ == null)))){
return (m__4549__auto__.cljs$core$IFn$_invoke$arity$2 ? m__4549__auto__.cljs$core$IFn$_invoke$arity$2(this$,fsm) : m__4549__auto__.call(null,this$,fsm));
} else {
...
return statecharts$service$IService$reload$dyn_67968(this$,fsm);
}
});
...
*/
statecharts.service.Service = (function (fsm,state,running,clock,transition_opts){
this.fsm = fsm;
this.state = state;
...
var self__ = this;
var ___$1 = this;
cljs.core.reset_BANG_(self__.state,statecharts.impl.transition.cljs$core$IFn$_invoke$arity$4(self__.fsm,cljs.core.deref(self__.state),event,self__.transition_opts));
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.with_meta(new cljs.core.Symbol(null,"fsm","fsm",-1716512779,null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"volatile-mutable","volatile-mutable",1731728411),true], null)),new cljs.core.Symbol(null,"state","state",-348086572,null),cljs.core.with_meta(new cljs.core.Symbol(null,"running","running",-1099466666,null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"volatile-mutable","volatile-mutable",1731728411),true], null)),new cljs.core.Symbol(null,"clock","clock",746230400,null),new cljs.core.Symbol(null,"transition-opts","transition-opts",-1380672275,null)], null);
}));
...
(statecharts.service.Service.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"statecharts.service/Service");
}));

/**
 * Positional factory function for statecharts.service/Service.
 */
statecharts.service.__GT_Service = (function statecharts$service$__GT_Service(fsm,state,running,clock,transition_opts){
return (new statecharts.service.Service(fsm,state,running,clock,transition_opts));
});
...
var map__67960 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([statecharts.service.default_opts(),opts], 0));
var map__67960__$1 = cljs.core.__destructure_map(map__67960);
var clock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67960__$1,new cljs.core.Keyword(null,"clock","clock",-894301127));
var transition_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67960__$1,new cljs.core.Keyword(null,"transition-opts","transition-opts",1273763494));
return (new statecharts.service.Service(fsm,cljs.core.atom.cljs$core$IFn$_invoke$arity$1(null),false,clock,transition_opts));
}));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(fsm,new cljs.core.Keyword(null,"scheduler","scheduler",-1882870208),statecharts.delayed.make_scheduler((function (p1__67961_SHARP_){
return statecharts.service.send(service,p1__67961_SHARP_);
}),service.clock));
});
